...
import com.abchau.archexamples.hdddeda.subscribe.application.web.SpringWebfluxHtmlSubscribeHandler;
...
public class RouterConfiguration {
	 ...
	 */
	@Bean
	public RouterFunction<ServerResponse> htmlRoutes(SpringWebfluxHtmlSubscribeHandler springWebfluxHtmlSubscribeHandler) {
		...
		return RouterFunctions.route()
				...
				// Subscribe routes
				.GET("/subscribe", accept(MediaType.TEXT_HTML), springWebfluxHtmlSubscribeHandler::showSubscribeForm)
				.POST("/subscribe", accept(MediaType.APPLICATION_FORM_URLENCODED), springWebfluxHtmlSubscribeHandler::processSubscribeForm)
				.GET("/subscribe/submitted", accept(MediaType.TEXT_HTML), springWebfluxHtmlSubscribeHandler::showSubscribeFormSubmitted)
				.after((req, res) -> {
