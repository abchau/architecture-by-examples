package com.github.abchau.oss.archexamples.subscription.inputadapter.web;
...
public class SubscribeControllerIT {
	...
	public void should_render_subscribe_page() throws Exception {
		// given
		RequestBuilder requestBuilder = get("/create");
	...
	public void should_render_input_is_empty() throws Exception {
		// given
		RequestBuilder requestBuilder = post("/create")
