...
link:chaos/README.adoc[Chaos Architecture]

link:3-tier/README.adoc[3-tier Architecture]

link:ddd/README.adoc[DDD]

link:hex/README.adoc[Hexagonal Architecture]

link:hddd/README.adoc[Hexagonal DDD]
